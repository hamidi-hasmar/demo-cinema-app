...
const movies = [
  {
    ...
    synopsis:
      "A rescue crew races against time after a deep-space signal leads them to a stranded passenger ship.",
    durationMinutes: 128,
    language: "English",
    genre: "Sci-Fi",
    rating: "PG-13",
  ...
  },
  {
    ...
    synopsis:
      "Three strangers meet at an old coffee shop and uncover a secret that changes the city overnight.",
    durationMinutes: 104,
    language: "Malay",
    genre: "Drama",
    rating: "P13",
  ...
  },
  {
    ...
    synopsis:
      "An elite unit must protect a key witness during a citywide storm and a coordinated attack.",
    durationMinutes: 116,
    language: "English",
    genre: "Action",
    rating: "18",
  ...
  },
  {
    ...
    synopsis:
      "A family rediscovers hope when their annual festival plans are interrupted by an unexpected visitor.",
    durationMinutes: 92,
    language: "Mandarin",
    genre: "Family",
    rating: "U",
